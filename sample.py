...
source_dir = os.getcwd() + "/Dataset_Spring2021_HW4_Q1"
dest_dir = os.getcwd() + "/response"
    ...
    if file.endswith(".jpg"):
        # [END aiplatform_predict_image_object_detection_sample]
            predict_image_object_detection_sample(
                project="844474434394",
                endpoint_id="7767776971353751552",
                location="us-central1",
                filename= source_dir + "/" + file,
                dest = dest_dir + "/" + file[:file.index(".jpg")] + ".json"
            )
